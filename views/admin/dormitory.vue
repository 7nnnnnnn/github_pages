    ...
    <el-dialog v-model="DialogVisible" title="添加用户" width="50%" center>
        <el-form :model="userinfo">
            ...
            <el-form-item label="密码" :label-width="formLabelWidth">
                <el-input v-model="userinfo.leader" autocomplete="off" />
            </el-form-item>
            <el-form-item label="学生,教师,教学辅助,管理员,后勤" :label-width="formLabelWidth">
                <el-input v-model="userinfo.maxNumber" autocomplete="off" />
            </el-form-item>
            <el-form-item label="标记删除" :label-width="formLabelWidth">
                <el-input v-model="userinfo.leftNumber" autocomplete="off" />
            </el-form-item>
            <el-form-item label="绑定：学生,教师,教辅,后勤1绑定 0 未绑定" :label-width="formLabelWidth">
                <el-input v-model="userinfo.liveNumber" autocomplete="off" />
            </el-form-item>
            <el-form-item label="邮箱" :label-width="formLabelWidth">
                <el-input v-model="userinfo.status" autocomplete="off" />
            </el-form-item>
            <el-form-item label="移动电话" :label-width="formLabelWidth">
                <el-input v-model="userinfo.comment" autocomplete="off" />
            </el-form-item>
        </el-form>
        <template #footer>
...
export default defineComponent({
    ...
    methods: {
        ...
        adduserinfo() {
            ...
            this.userinfo.comment = '宿舍编号第一个数字1代表A面,2代表B面,后面三位代表门牌号';
            this.userinfo.name = '2#';
            this.userinfo.maxNumber = 6;
            this.userinfo.leftNumber = 0;
            this.userinfo.liveNumber = 6;
            this.userinfo.status = 1;
            this.userinfo.school = '泉州信息工程学院';
            this.userinfo.type = 0;
            this.userinfo.building = '2号楼';
