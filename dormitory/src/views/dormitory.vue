<template>
    <div class="head">
        ...
        <el-table :data="dormitorys" style="width: 100%">
            ...
            <el-table-column prop="maxNumber" label="maxNumber" width="120" />
            <el-table-column prop="leftNumber" label="leftNumber" width="120" />
            <el-table-column prop="liveNumber" label="liveNumber" width="120" />
...
import { getalldormitory, addDormitory, getonedormitory, deleteDormitory, editDormitory } from "../http"//在http的文件夹里index.js 是相对应的
